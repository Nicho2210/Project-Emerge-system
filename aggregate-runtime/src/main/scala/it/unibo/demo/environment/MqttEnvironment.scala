...
import it.unibo.demo.{ID, Info, ObstacleSize}
 ...
 */
class MqttEnvironment(data: Map[ID, (Position, Info)], private val neighbours: Map[ID, Set[ID]], val obstacles: Map[ID, (Position, ObstacleSize)])
